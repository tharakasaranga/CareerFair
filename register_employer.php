    ...
    <div class="row">
      ...
      <div class="col">
        <div class="card">
          ...
          <div class="card-body">
            <form action="backEnd/insertCompanyDetails.php" method="post" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="industry" class="form-control" placeholder="Enter Industry Type">
              </div>
